...
{ 
  ...
  /* Send SPI3 data */ 
  *((__IO uint8_t*)&hspi2.Instance->DR) = cmd;
...
#else	
	SPISend = cmd;
	HAL_SPI_TransmitReceive(&hspi2, &SPISend, &SPIRecv,1, 100);
#endif
} 
